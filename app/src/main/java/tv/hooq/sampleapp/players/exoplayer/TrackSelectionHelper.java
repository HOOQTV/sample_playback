...
/* package */ public class TrackSelectionHelper implements View.OnClickListener,
    ...
    public void showSelectionDialog(Activity activity, CharSequence title, MappedTrackInfo trackInfo,
                                    int rendererIndex, List<String> labels) {
        ...
        builder.setTitle(title)
                .setView(buildView(builder.getContext(), labels))
    ...
    private View buildView(Context context, List<String> labels) {
        ...
        for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
            ...
            for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
                ...
                String label = ExoUtil.getInstance().buildTrackName(group.getFormat(trackIndex));
                if(labels != null) {
                    if(groupIndex < labels.size()) {
                        label = labels.get(groupIndex);
                    }
                }
                trackView.setText(label);
